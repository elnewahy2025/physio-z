...
import { FileEdit, AlertCircle, Sparkles } from 'lucide-react';
import api from '../../../lib/api';
import { useI18n } from '../../../i18n';
import ClinicalDecisionModal from './ClinicalDecisionModal';
import { type TreatmentProtocol } from '../services/clinical-decision.service';

export default function SessionCharting({ onClose }: { onClose: () => void }) {
