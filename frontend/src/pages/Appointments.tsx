    ...
    <div className="space-y-6">
      <Card>
        <CardHeader
          ...
          subtitle={`${list.length} ${lang === 'ar' ? '?�?�?�?�' : 'appointments'}`}
          action={
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6 rounded-xl border border-primary-200 bg-primary-50/50 p-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {userRole !== 'THERAPIST' && (
          <div>
            <label className="label">{lang === 'ar' ? '?�?�?�?�?�?? ?�?�?�?�?�?�' : 'Therapist'}</label>
            <select
              ...
              required
            >
              <option value="">{lang === 'ar' ? '?�?�???� ?�?�?�?�?�??' : 'Select therapist'}</option>
              {therapists.map((th) => (
        ...
        <div>
          ...
          <select
            ...
            className="input"
          >
            <option value="">{lang === 'ar' ? '?�?�?�?� ???�???�' : 'No room'}</option>
            {rooms.map((r) => (
        ...
        <div>
          <label className="label">{lang === 'ar' ? '?�?�???�?�???� ?�?�?�?�?�??' : 'Date & Time'}</label>
          <input
            type="datetime-local"
        ...
        <div>
          <label className="label">{lang === 'ar' ? '?�?�?�?�?� (?�?�???�?�)' : 'Duration (min)'}</label>
          <select
        ...
        <div>
          <label className="label">{lang === 'ar' ? '?�?�?�?�?�?�??' : 'Notes'}</label>
          <input
            type="text"
            value={formData.notes}
            onChange={(e) => setFormData({ ...formData, notes: e.target.value })}
            className="input"
            placeholder={lang === 'ar' ? '?�?�?�?�?�?�?? ?�?�?�?????�...' : 'Additional notes...'}
          />
        </div>
      </div>
